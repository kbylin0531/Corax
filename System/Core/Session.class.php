...
class Session {
    ...
    public static function init(array $config=null){
        ...
        if(!isset(self::$driver)){
            ...
            SEK::merge(self::$convention,isset($config)?$config:Configer::load('session'));
            $classname = 'System\\Core\\Session\\'.self::$convention['SESSION_MODE'];
