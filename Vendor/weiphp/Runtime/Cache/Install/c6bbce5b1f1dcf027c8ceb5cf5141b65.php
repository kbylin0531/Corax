...
<html>
    <head>
        ...
        <!-- Le styles -->
        <link href="/corax/Vendor/weiphp/Public/static/bootstrap/css/bootstrap.css?v=<?php echo SITE_VERSION;?>" rel="stylesheet">
        <link href="/corax/Vendor/weiphp/Public/static/bootstrap/css/bootstrap-responsive.css?v=<?php echo SITE_VERSION;?>" rel="stylesheet">
        <link href="/corax/Vendor/weiphp/Public/Install/css/install.css?v=<?php echo SITE_VERSION;?>" rel="stylesheet">

        <!-- Le HTML5 shim, for IE6-8 support of HTML5 elements -->
        <!--[if lt IE 9]>
            <script src="assets/js/html5shiv.js?v=<?php echo SITE_VERSION;?>"></script>
        <![endif]-->
        <script src="/corax/Vendor/weiphp/Public/static/jquery-1.10.2.min.js"></script>
        <script src="/corax/Vendor/weiphp/Public/static/bootstrap/js/bootstrap.js?v=<?php echo SITE_VERSION;?>"></script>
    </head>
            ...
            <div class="navbar-inner">
                <div class="container">
                    ...
                    <div class="nav-collapse collapse">
                    	<p class="install_logo"><span><img width="50px;" src="/corax/Vendor/weiphp/Public/Install/img/install.png"/></span></p>
